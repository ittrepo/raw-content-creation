...
def process_innstanttravel_data(giata_folder, vervotech_folder, hotel_id):
    ...
    if os.path.exists(path_giata):
        ...
        # If neither exists, create the folder in the giata folder by default.
        folder_path = path_giata
        create_directory(folder_path)
...
def main(ittid):
    ...
    # Step 8: Process Innstant travel data using hotel ID "707764"
    process_innstanttravel_data(giata_folder, vervotech_folder, "707764")
